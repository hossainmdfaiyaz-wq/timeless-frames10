        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mb-8 flex justify-center">
            <div className="relative">
              <img src={profilePicture} alt="MD FAIYAZ HOSSAIN" className="w-32 h-32 md:w-40 md:h-40 rounded-full object-cover object-center border-4 border-accent shadow-2xl" />
